...
>
  <div class="flex items-center justify-between h-full px-4 sm:px-6">
    <div class="flex items-center gap-3">
      <a
        href="/"
        class="flex items-center gap-2 sm:gap-3 hover:text-gray-400 text-gray-300 transition-colors duration-300"
      >
        <img src="/favicon.png" alt="Logo" class="h-8 w-8 sm:h-12 sm:w-12" />
        <span class="font-semibold text-base sm:text-lg hidden xs:block">Plug Studios</span>
      </a>
    </div>
      ...
      <div class="relative">
        <div class="relative">
          <input
            ...
            px-4 py-1.5 w-48 sm:w-64 md:w-80 outline-none focus:ring-1 focus:ring-gray-700
          ...
          />
          <kbd
            class="absolute right-2 top-1/2 -translate-y-1/2 hidden md:inline-flex
